...
const Bible = () => {
	...
	const zoomEvent = Animated.event([ { nativeEvent: { scale } } ], {
				...
				>
					<View style={styles.container}>
						...
						<Text style={styles.description}>
							...
							and God divided the light from the darkness. 5 And
						...
						<Text style={styles.description}>
							...
							it was so. 8 And God called the firmament Heaven.
						...
						<Text style={styles.description}>
							...
							good. 13 And the evening and the morning were the
							third day. 14 And God said, Let there be lights in
							the firmament of the heaven to divide the day from
							the night; and let them be for signs, and for
							seasons, and for days, and years: 15 And let them be
							...
							stars also. 17 And God set them in the firmament of
							the heaven to give light upon the earth, 18 And to
							...
							fourth day. 20 And God said, Let the waters bring
